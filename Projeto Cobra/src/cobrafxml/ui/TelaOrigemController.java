 ...
 * @author Leonardo
 */
public class TelaOrigemController implements Initializable {
    ...
    private void carregaTabela()
    {
        ...
        ArrayList<Origem> todasOrigens = new ArrayList();   
        todasOrigens = ctrlOrigem.buscarTodos("");
        ObservableList <Origem> conteudoTabela;
        conteudoTabela = FXCollections.observableArrayList(todasOrigens);    
        tcCodigo.setCellValueFactory(new PropertyValueFactory<>("codigo"));
        tcDescricao.setCellValueFactory(new PropertyValueFactory<>("descricao"));     
        tvOrigem.setItems(conteudoTabela);
    }
    @Override
    ...
    private void clkbtnConfirmar(ActionEvent event) {
        DALOrigem ctrlOrigem = new DALOrigem();
        Origem ori = new Origem(txDescricao.getText());
        if (txCodigo.getText() == null || txCodigo.getText().trim().equals(""))
        {
           ctrlOrigem.cadOrigem(ori);
